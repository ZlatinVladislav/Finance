...
//             };
//
//             var transactionViewModelEditDto = new TransactionEditDto
//             {              
//                 Money = 5,             
//             };
//             var content = JsonConvert.SerializeObject(transactionViewModelDto);
...
//
//             // Act
//             var response = await _client.PutAsync($"/api/Transaction?id={transactionViewModelEditDto.Id}", stringContentEdited);
//
//             // Assert
//             response.StatusCode.Should().Be(HttpStatusCode.BadRequest);
//         }
...
//
//             // Assert
//             var transaction = JsonConvert.DeserializeObject<TransactionListDto>(responseString);
